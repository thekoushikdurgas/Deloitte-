...
BEGIN
  ...
  EXCEPTION
    WHEN ERR_MAP_EXISTS THEN
      RAISE EXCEPTION 'Error -20110: %', 'MDM_THEME_MOLECULE_MAP_IOF';
    WHEN ERR_MOLEC_ID_MISSING THEN
      RAISE EXCEPTION 'Error -20111: %', 'MDM_THEME_MOLECULE_MAP_IOF';
    WHEN ERR_UPD_INV_MAP THEN
      RAISE EXCEPTION 'Error -20112: %', 'MDM_THEME_MOLECULE_MAP_IOF';
    WHEN ERR_INS_INV_MAP THEN
      RAISE EXCEPTION 'Error -20113: %', 'MDM_THEME_MOLECULE_MAP_IOF';
    WHEN ERR_INV_MOL_SEQUENCE THEN
      RAISE EXCEPTION 'Error -20120: %', 'MDM_THEME_MOLECULE_MAP_IOF';
END;
