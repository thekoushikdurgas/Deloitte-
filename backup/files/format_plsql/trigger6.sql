...
BEGIN
  ...
  EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
      RAISE EXCEPTION 'Error -20600: %', V_TRIGGER_NAME;
    WHEN V_NO_UPDATE_EVOLVED_TO_TERMINATED THEN
      RAISE EXCEPTION 'Error -20800: %', V_TRIGGER_NAME;
    WHEN V_NO_UPDATE_TO_EVOLVED THEN
      RAISE EXCEPTION 'Error -20900: %', V_TRIGGER_NAME;
    WHEN V_EXPLORATORY_THEMENO_NOT_NULL THEN
      RAISE EXCEPTION 'Error -20940: %', V_TRIGGER_NAME;
END;
